...
/**
 * <p>Methods to serialize and de-serialize messages to the Xxxxxxx network format as defined in
 ...
 * </ul>
 */
public class XxxxxxxSerializer {
    private static final Logger log = LoggerFactory.getLogger(XxxxxxxSerializer.class);
    ...
    /**
     * Constructs a XxxxxxxSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public XxxxxxxSerializer(NetworkParameters params) {
     ...
     */
    public XxxxxxxSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("XxxxxxxSerializer doesn't currently know how to serialize " + message.getClass());
        }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Xxxxxxx protocol message has the following format.
        //
        ...
        XxxxxxxPacketHeader header = new XxxxxxxPacketHeader(in);
     ...
     */
    public XxxxxxxPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new XxxxxxxPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link XxxxxxxSerializer#deserializeHeader}.
     */
    public Message deserializePayload(XxxxxxxPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class XxxxxxxPacketHeader {
        ...
        public XxxxxxxPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
