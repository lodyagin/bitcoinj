...
public class CoinDefinition {
    ...
    public static final String coinURIScheme = "xxxxxxx";
    ...
    public static final int Port    = 2014130511;//protocol.h GetDefaultPort(testnet=false)
    public static final int TestPort= 2014130513;//protocol.h GetDefaultPort(testnet=true)
