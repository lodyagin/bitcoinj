...
/**
 * Parameters for the testnet, a separate public instance of Xxxxxxx that has relaxed rules suitable for development
 * and testing of applications and new Xxxxxxx versions.
 */
