...
public class XxxxxxxSerializerTest {
    ...
    public void testAddr() throws Exception {
        XxxxxxxSerializer bs = new XxxxxxxSerializer(MainNetParams.get());
    ...
    public void testLazyParsing()  throws Exception {
        XxxxxxxSerializer bs = new XxxxxxxSerializer(MainNetParams.get(), true, false);
    ...
    private void testCachedParsing(boolean lazy)  throws Exception {
        XxxxxxxSerializer bs = new XxxxxxxSerializer(MainNetParams.get(), lazy, true);
    ...
    @Test
    public void testXxxxxxxPacketHeader() {
        try {
            new XxxxxxxSerializer.XxxxxxxPacketHeader(ByteBuffer.wrap(new byte[]{0}));
            fail();
        ...
        try {
            new XxxxxxxSerializer.XxxxxxxPacketHeader(ByteBuffer.wrap(wrongMessageLength));
            fail();
    ...
    public void testSeekPastMagicBytes() {
        ...
        try {
            new XxxxxxxSerializer(MainNetParams.get()).seekPastMagicBytes(ByteBuffer.wrap(brokenMessage));
            fail();
        } catch (BufferUnderflowException e) {
            // expected
        }
