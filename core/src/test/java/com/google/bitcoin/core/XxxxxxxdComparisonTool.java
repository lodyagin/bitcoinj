 ...
 */
public class XxxxxxxdComparisonTool {
    private static final Logger log = LoggerFactory.getLogger(XxxxxxxdComparisonTool.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            store = new H2FullPrunedBlockStore(params, args.length > 0 ? args[0] : "XxxxxxxdComparisonTool", blockList.maximumReorgBlockCount);
